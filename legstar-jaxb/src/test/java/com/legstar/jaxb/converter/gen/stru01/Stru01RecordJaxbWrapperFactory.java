package com.legstar.jaxb.converter.gen.stru01;
...
public class Stru01RecordJaxbWrapperFactory implements JaxbWrapperFactory {

    public JaxbWrapper<?> create(CobolComplexType type) {
        if ("ComSubRecord".equals(type.getName())) {
            return new ComSubRecordJaxbWrapper();
        }
    ...
    public JaxbWrapper < ? > create(CobolComplexType type, Object jaxb) {
        if ("ComSubRecord".equals(type.getName())) {
            return new ComSubRecordJaxbWrapper((legstar.test.jaxb.stru01.ComSubRecord) jaxb);
        }
        if ("Stru01Record".equals(type.getName())) {
    ...
    public class ComSubRecordJaxbWrapper extends JaxbWrapper<legstar.test.jaxb.stru01.ComSubRecord> {
        ...
        public ComSubRecordJaxbWrapper() {
            this(new legstar.test.jaxb.stru01.ComSubRecord());
        }

        public ComSubRecordJaxbWrapper(legstar.test.jaxb.stru01.ComSubRecord jaxb) {
            super(jaxb);
        }
    ...
    public class Stru01RecordJaxbWrapper extends JaxbWrapper<legstar.test.jaxb.stru01.Stru01Record> {

        public Stru01RecordJaxbWrapper() {
            this(new legstar.test.jaxb.stru01.Stru01Record());
        }

        public Stru01RecordJaxbWrapper(legstar.test.jaxb.stru01.Stru01Record jaxb) {
            super(jaxb);
        }
        ...
        public String toString() {
            ...
            builder.append(new ComSubRecordJaxbWrapper(getJaxb().getComSubRecord()));
            builder.append("}");
            return builder.toString();
        }
