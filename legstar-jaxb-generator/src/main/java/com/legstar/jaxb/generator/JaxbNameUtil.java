...
/**
 * The JAXB classes that are generated by XJC using the XML schema, derive their
 * package name from the XML schema target namespace. Here we mimic what XJC
 * does.
 * <p/>
 * Code mostly comes from com.sun.xml.bind.api.impl.NameConverter
 */
public class JaxbNameUtil {
    ...
    private JaxbNameUtil() {
    }

    /**
     * get the jaxb package name out of the target namespace.
     * 
     * @param xmlSchema
     * @return null if unable to derive a package name
     */
    public static String getJaxbPackageName(XmlSchema xmlSchema) {
