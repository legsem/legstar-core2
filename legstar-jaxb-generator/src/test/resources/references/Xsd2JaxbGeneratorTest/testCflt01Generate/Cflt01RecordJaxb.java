...
public class Cflt01RecordJaxb implements JaxbWrapperFactory {
    ...
    public JaxbWrapper < ? > create(CobolComplexType type, Object jaxb) {
        if ("CfltInfo9".equals(type.getName())) {
            return new CfltInfo9JaxbWrapper((test.example.CfltInfo9) jaxb);
        }
        if ("CfltParent1".equals(type.getName())) {
            return new CfltParent1JaxbWrapper((test.example.CfltParent1) jaxb);
        }
        if ("CfltInfo13".equals(type.getName())) {
            return new CfltInfo13JaxbWrapper((test.example.CfltInfo13) jaxb);
        }
        if ("CfltParent2".equals(type.getName())) {
            return new CfltParent2JaxbWrapper((test.example.CfltParent2) jaxb);
        }
        if ("Cflt01Record".equals(type.getName())) {
            return new Cflt01RecordJaxbWrapper((test.example.Cflt01Record) jaxb);
        }
        throw new InvalidComplexTypeNameException(type.getName());
    }

    public class CfltInfo9JaxbWrapper extends JaxbWrapper<test.example.CfltInfo9> {

        public CfltInfo9JaxbWrapper() {
            this(new test.example.CfltInfo9());
        }

        public CfltInfo9JaxbWrapper(test.example.CfltInfo9 jaxb) {
            super(jaxb);
        }
    ...
    public class CfltParent1JaxbWrapper extends JaxbWrapper<test.example.CfltParent1> {

        public CfltParent1JaxbWrapper() {
            this(new test.example.CfltParent1());
        }

        public CfltParent1JaxbWrapper(test.example.CfltParent1 jaxb) {
            super(jaxb);
        }
    ...
    public class CfltInfo13JaxbWrapper extends JaxbWrapper<test.example.CfltInfo13> {

        public CfltInfo13JaxbWrapper() {
            this(new test.example.CfltInfo13());
        }

        public CfltInfo13JaxbWrapper(test.example.CfltInfo13 jaxb) {
            super(jaxb);
        }
    ...
    public class CfltParent2JaxbWrapper extends JaxbWrapper<test.example.CfltParent2> {

        public CfltParent2JaxbWrapper() {
            this(new test.example.CfltParent2());
        }

        public CfltParent2JaxbWrapper(test.example.CfltParent2 jaxb) {
            super(jaxb);
        }
    ...
    public class Cflt01RecordJaxbWrapper extends JaxbWrapper<test.example.Cflt01Record> {

        public Cflt01RecordJaxbWrapper() {
            this(new test.example.Cflt01Record());
        }

        public Cflt01RecordJaxbWrapper(test.example.Cflt01Record jaxb) {
            super(jaxb);
        }
