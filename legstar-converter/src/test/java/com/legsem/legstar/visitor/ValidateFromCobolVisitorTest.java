...
import com.legsem.legstar.type.gen.Rdef03Factory;
import com.legsem.legstar.type.gen.Stru01Factory;
...
public class ValidateFromCobolVisitorTest {
    ...
    public void tesFlat01Invalid() {
        ...
        visitor = new ValidateFromCobolVisitor(
    ...
    public void tesStru01Valid() {
        ...
        ValidateFromCobolVisitor visitor = new ValidateFromCobolVisitor(
                ...
                0);
        visitor.visit(Stru01Factory.createStru01Record(cobolContext));
        assertTrue(visitor.isValid());
    ...
    public void tesRdef03ValidDefaultStrategyFirstAlternative() {
        ...
        ValidateFromCobolVisitor visitor = new ValidateFromCobolVisitor(
                ...
                0);
        visitor.visit(Rdef03Factory.createRdef03Record(cobolContext));
        assertTrue(visitor.isValid());
