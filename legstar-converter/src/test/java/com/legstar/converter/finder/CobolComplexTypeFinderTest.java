...
public class CobolComplexTypeFinderTest {
    ...
    public void testFindFlat01OneField() {
        CobolComplexTypeFinder finder = new CobolComplexTypeFinder(Flat01Factory.create(cobolContext), "comNumber");
    ...
    public void testFindFlat01TwoFields() {
        CobolComplexTypeFinder finder = new CobolComplexTypeFinder(Flat01Factory.create(cobolContext), "comName");
    ...
    public void testFindFlat01AllFields() {
        CobolComplexTypeFinder finder = new CobolComplexTypeFinder(Flat01Factory.create(cobolContext), null);
