...
public class CobolComplexTypeFinderTest {
    ...
    public void testFindFlat01OneField() {
        CobolComplexTypeFinder finder = new CobolComplexTypeFinder(cobolContext, new CobolFlat01Record(), "comNumber");
    ...
    public void testFindFlat01TwoFields() {
        CobolComplexTypeFinder finder = new CobolComplexTypeFinder(cobolContext, new CobolFlat01Record(), "comName");
    ...
    public void testFindFlat01AllFields() {
        CobolComplexTypeFinder finder = new CobolComplexTypeFinder(cobolContext, new CobolFlat01Record(), null);
