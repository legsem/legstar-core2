...
public class Cob2ObjectVisitorTest {
    ...
    @Test
    public void testConvertFlat01Partial() {
        byte[] hostData = HexUtils
                .decodeHex("F0F0F1F0F4F3D5C1D4C5F0F0F0F0F4F3404040404040404040400215000F");
        Cob2ObjectVisitor visitor = new Cob2ObjectVisitor(cobolContext,
                hostData, 0, hostData.length - 4);
        visitor.visit(new CobolFlat01Record());
        assertEquals(
                "{comNumber=1043, comName=NAME000043, comAmount=NAME000043}",
                visitor.getResultObject().toString());
    ...
    public void testConvertArdo02OdoObjectInRedefineSecondAlternative() {
        Cob2ObjectVisitor visitor = new Cob2ObjectVisitor(cobolContext,
                HexUtils.decodeHex("C1C2"), 0, 2, new FromCobolChoiceStrategy() {
    ...
    public void testConvertRdef04CustomStrategyWithVariables() {
        byte[] hostData = HexUtils.decodeHex("c1c2c300000000000000e9");
        Cob2ObjectVisitor visitor = new Cob2ObjectVisitor(cobolContext,
                hostData, 0, hostData.length,
    ...
    public void testConvertAlltypes() {
        Cob2ObjectVisitor visitor = new Cob2ObjectVisitor(cobolContext,
                HexUtils.decodeHex("c1c2c3c4" + "01020000" + "fc5c" + "000f"
                        ...
                        + "361677a4590fab60" + "361677a4590fab60"));
    ...
    public void testConvertDplarchtTransactionChoice() {
        ...
        Cob2ObjectVisitor visitor = new Cob2ObjectVisitor(cobolContext,
                hostData, 0, hostData.length, new DplarchtChoiceStrategy());
        visitor.visit(new com.legstar.base.type.gen.dplarcht.CobolDfhcommarea());
        assertEquals(
    ...
    public void testConvertDplarchtProgramChoice() {
        byte[] hostData = HexUtils.decodeHex("0001" + "5c404040" + "4040404040404040"
                + "000000000f" + "0000" + "00000001"
        ...
        Cob2ObjectVisitor visitor = new Cob2ObjectVisitor(cobolContext,
                hostData,
                0, hostData.length, new DplarchtChoiceStrategy());
        visitor.visit(new com.legstar.base.type.gen.dplarcht.CobolDfhcommarea());
        assertEquals(
