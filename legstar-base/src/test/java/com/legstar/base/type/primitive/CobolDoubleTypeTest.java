...
public class CobolDoubleTypeTest {
    ...
    public void testFromHostDouble() {
        ...
        assertEquals("7.982006699999995E-14",
                getDoubleValue("361677a4590fab68"));
    ...
    public void testFromHostNumber() {
        ...
        assertEquals("345006.567799999960698187351226806640625",
                getValue(java.math.BigDecimal.class, "45543ae915b573e8"));
        assertEquals("345006",
                getValue(java.math.BigInteger.class, "45543ae915b573e8"));
    ...
    private <T extends Number> CobolDoubleType < T > getType(Class < T > clazz) {
        return new CobolDoubleType.Builder < T >(clazz).cobolName("DOUBLETEST")
                .build();
    }
